...
public class Main extends javax.swing.JFrame{
    ...
    private GeoPosition getGeoPositionFromAddress(String address) {
        try {
            // Construye la URL para la solicitud de geocodificación
            String apiKey = "AIzaSyC3wkJtdntj6Gg4LJmNZ_0F8FcRh1Rjeg0"; // Considera mover esto a un lugar seguro
            ...
            if (responseCode == 200) {
                // Lee la respuesta
                String jsonResponse = new java.util.Scanner(url.openStream(), "UTF-8").useDelimiter("\\A").next();
    ...
    private void initComponents() {
        ...
        jXMapViewerLayout.setHorizontalGroup(
            ...
            .addGroup(jXMapViewerLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tFBuscador, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tFBuscadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tFBuscadorActionPerformed
      String searchTerm = tFBuscador.getText().trim();
        if (!searchTerm.isEmpty()) {
            GeoPosition geo = getGeoPositionFromAddress(searchTerm);
            if (geo != null) {
                jXMapViewer.setAddressLocation(geo);
                jXMapViewer.setZoom(12);
            } else {
                JOptionPane.showMessageDialog(Main.this, "¡Ubicación no encontrada!");
            }
        }
